...
def test_overlay_css_contract() -> None:
    ...
    assert_contains_all(
        ...
        [
            ...
            '.results-summary-bar[data-status="ready"] {',
            '.results-summary-bar[data-status="ready"] .results-summary-message {',
            '.results-summary-bar[data-status="ready"] .results-summary-actions {',
            '.results-summary-bar[data-status="ready"] .results-summary-action {',
...
def test_siyu_maplibre_route_split_contract() -> None:
    ...
    assert_contains_all(
        ...
        [
            ...
            'expected EPSG:4326 or EPSG:3857 GeoJSON',
