...
TEST_MARKER_BY_FILE: dict[str, str] = {
    ...
    "test_admin_settings_service.py": "unit",
    "test_assets.py": "unit",
    ...
    "test_cadastral_highlight_api.py": "unit",
    "test_cadastral_highlight_cache.py": "unit",
    "test_cadastral_highlight_service_etag.py": "unit",
    "test_parcel_render_build_service.py": "unit",
    "test_parcel_render_repository_bbox.py": "unit",
    ...
    "test_lands_list_filters_api.py": "integration",
    ...
    "test_poi_repository_migration.py": "unit",
...
def app_env() -> dict[str, str]:
    return {
        ...
        "CADASTRAL_FGB_PATH": "data/LSMD_CONT_LDREG_44210_202512.fgb",
